  ...
  return (
    <Box variant="shadow" className="rounded-lg flex flex-col flex-1">
      <Box variant="pinkPurple" className="px-6 py-5 rounded-t-[inherit]">
        <p className="text-xl font-semibold text-text">Leaderboard (Design)</p>
      </Box>
      ...
      >
        <p className="font-semibold text-[14px] text-left flex-1 text-text/90">
          Address
        </p>
        <p className="font-semibold text-[14px] text-center flex-1 text-text/90">
          Overall Rank
        </p>
        <p className="font-semibold text-[14px] text-right flex-1 text-text/90">
          Total Points
        </p>
      </Box>
      ...
      <div className="flex flex-col">
        <div className="flex justify-between items-center py-4 px-10 border-b border-border/20">
          <p className="font-medium text-[14px] text-left flex-1 text-text/90">
            0x03eb...a44f636
          </p>
          <p className="font-medium text-[14px] text-center flex-1 text-text">
            #1
          </p>
          <p className="font-medium text-[14px] text-right flex-1 text-text">
            2100
          </p>
        </div>
